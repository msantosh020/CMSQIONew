...
public class QIUPropertiesUtil {
    public QIUPropertiesUtil() {
        super();
    }
    ...
    private static void readProperties() {
        ...
        try {
            ...
            QIUPropertiesUtil prop = new QIUPropertiesUtil();
            ...
            appProperties = new Properties();
            ResourceBundle rs = ResourceBundle.getBundle("QIU");
    ...
    public InputStream getFileStream() {
        ...
        try {
            in = servletClassLoader.getSystemResourceAsStream("QIU.properties");
        } catch (Exception e) {
