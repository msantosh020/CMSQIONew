...
public class EnvironmentPropertiesUtil {
    public EnvironmentPropertiesUtil() {
        super();
    }
    ...
    private static void readProperties() {
        ...
        try {
            ...
            EnvironmentPropertiesUtil prop = new EnvironmentPropertiesUtil();
            ...
            e.printStackTrace();
            System.out.println("EnvironmentPropertiesUtil Exception is ------------------------" + e);
            appProperties = new Properties();
            ResourceBundle rs = ResourceBundle.getBundle("Environment");
            System.out.println("EnvironmentPropertiesUtil  --------------------- rs" + rs);
            ...
            while (iter.hasNext()) {
                ...
                System.out.println("EnvironmentPropertiesUtil --------------------- key" + key + ":;value=" + value);
    ...
    public InputStream getFileStream() {
        ...
        try {
            in = servletClassLoader.getSystemResourceAsStream("Environment.properties");
        } catch (Exception e) {
